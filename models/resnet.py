...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10, activation='relu', weight_init='gaussian'):
...
def ResNet18(activation='relu', weight_init='gaussian'):
    return ResNet(BasicBlock, [2, 2, 2, 2], activation=activation, weight_init=weight_init)


def ResNet34(activation='relu', weight_init='gaussian'):
